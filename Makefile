...
COMMON_FULL_PATH=$(SOURCE_FOLDER)/$(COMMON_FOLDER)
...
WINDOW_SERVER_SOURCES += $(wildcard $(SOURCE_FOLDER)/packet_table/*.c)
COMMON_SOURCES = $(wildcard $(COMMON_FULL_PATH)/*.c)
...
SENDER_SRC += $(COMMON_SOURCES)
SENDER_SRC += $(WINDOW_SERVER_SOURCES)
