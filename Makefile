...
WINDOW_SERVER_OBJECTS=$(WINDOW_SERVER_SOURCES:.c=.o)
...
sender: $(CLIENT_OBJECTS) $(PACKET_OBJECTS) $(SEND_RECEIVE_DATA_OBJECTS); \
		$(CC) $(CFLAGS) $(CLIENT_OBJECTS) $(PACKET_OBJECTS) $(SEND_RECEIVE_DATA_OBJECTS) $(LDFLAGS) -o sender;

receiver: $(STACK_OBJECTS) $(WINDOW_SERVER_OBJECTS) $(SERVER_OBJECTS) $(PACKET_OBJECTS) $(SEND_RECEIVE_DATA_OBJECTS); \
		$(CC) $(CFLAGS) $(STACK_OBJECTS) $(WINDOW_SERVER_OBJECTS) $(SERVER_OBJECTS) $(PACKET_OBJECTS) $(SEND_RECEIVE_DATA_OBJECTS) $(LDFLAGS) -o receiver;
...
clean:
	@rm -f $(PACKET_OBJECTS) $(STACK_OBJECTS) $(WINDOW_SERVER_OBJECTS) $(SEND_RECEIVE_DATA_OBJECTS) $(CLIENT_OBJECTS) $(SERVER_OBJECTS) sender receiver testsScript